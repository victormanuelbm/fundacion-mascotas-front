                                        ...
                                        <div class="col-lg-4">
                                            <base-input label="Usuarios" :valid="validarUsuario">
                                                <select class="form-control" v-model="model.idUsuario">
                                                    <option v-for="usuario in usuarios" :key="usuario.idUsuario" :value="usuario.idUsuario" >{{ usuario.nombre }}</option>
                                                </select>
                                            </base-input>
                                        </div>
                                        <div class="col-lg-4">
  ...
  export default {
    ...
    data() {
      return {
        ...
        usuarios: [
            {idUsuario: 1, nombre: 'Jorge Mojica'},
            {idUsuario: 2, nombre: 'Diego Navas'},
            {idUsuario: 3, nombre: 'Jose Luis Suarez'}
        ]
      }
    },
    computed: {
